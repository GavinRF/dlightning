...
#define LOW_PRECISION`),t}function Lg(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Rl?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===Ic?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===cn&&(t="SHADOWMAP_TYPE_VSM"),t}function Dg(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case gi:case _i:t="ENVMAP_TYPE_CUBE";break;case Ys:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Ug(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case _i:t="ENVMAP_MODE_REFRACTION";break}return t}function Ng(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Cl:t="ENVMAP_BLENDING_MULTIPLY";break;case Kc:t="ENVMAP_BLENDING_MIX";break;case $c:t="ENVMAP_BLENDING_ADD";break}return t}function Fg(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Og(s,t,e,n){const i=s.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=Lg(e),l=Dg(e),h=Ug(e),u=Ng(e),d=Fg(e),p=Tg(e),g=bg(r),v=i.createProgram();let m,f,b=e.glslVersion?"#version "+e.glslVersion+`
